...
/*new*/
import { DeclarelistComponent} from "./project-declare/declarelist/declarelist.component";
// pro
...
export const routes = [
    {
        ...
        children: [
            { path: '', redirectTo: 'declare', pathMatch: 'full' },
            ...
            { path: 'approval', loadChildren: './project-approval/project-approval.module#ProjectApprovalModule' },
            { path: 'accept', loadChildren: './project-accept/project-accept.module#ProjectAcceptModule' },
